...
public class LoginUI extends JFrame {
	...
	public LoginUI() throws ClassNotFoundException, SQLException {
		...
		btnLogIn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String query = "select * from login.login where username = '"+textField.getText()+"' and password = '"+passwordField.getText()+"'";
		...
		btnLogIn.setBounds(115, 198, 101, 30);
		...
		btnClear.setBounds(235, 199, 101, 30);
		contentPane.add(btnClear);
		
		JButton btnBackToLog = new JButton("Back to Register");
		...
		btnBackToLog.setBounds(115, 240, 221, 30);
