...
public class GradingSystem extends JFrame {
	...
	public GradingSystem() {
		...
		txtCMPRG.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				txtIII.requestFocusInWindow();
			}
		});
		txtCMPRG.setForeground(new Color(255, 255, 255));
		txtCMPRG.setBackground(new Color(54, 54, 54));
		txtCMPRG.setColumns(10);
		txtCMPRG.setBounds(182, 26, 185, 30);
		contentPane.add(txtCMPRG);
		
		txtIII = new JTextField();
		txtIII.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				txtWI.requestFocusInWindow();
			}
		});
		txtIII.setForeground(new Color(255, 255, 255));
		txtIII.setBackground(new Color(54, 54, 54));
		txtIII.setColumns(10);
		txtIII.setBounds(182, 68, 185, 30);
		contentPane.add(txtIII);
		
		txtWI = new JTextField();
		txtWI.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				txtPRDV.requestFocusInWindow();
			}
		});
		txtWI.setForeground(new Color(255, 255, 255));
		txtWI.setBackground(new Color(54, 54, 54));
		txtWI.setBounds(182, 110, 185, 30);
		contentPane.add(txtWI);
		txtWI.setColumns(10);
		
		txtPRDV = new JTextField();
		txtPRDV.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				txtEAPP.requestFocusInWindow();
			}
		});
		txtPRDV.setForeground(new Color(255, 255, 255));
		txtPRDV.setBackground(new Color(54, 54, 54));
		txtPRDV.setColumns(10);
		txtPRDV.setBounds(182, 152, 185, 30);
		contentPane.add(txtPRDV);
		
		txtEAPP = new JTextField();
		txtEAPP.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				txtCPAR.requestFocusInWindow();
			}
		});
		txtEAPP.setForeground(new Color(255, 255, 255));
		txtEAPP.setBackground(new Color(54, 54, 54));
		txtEAPP.setColumns(10);
		txtEAPP.setBounds(182, 194, 185, 30);
		contentPane.add(txtEAPP);
		
		txtCPAR = new JTextField();
		txtCPAR.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				txtPE.requestFocusInWindow();
			}
		});
		txtCPAR.setForeground(new Color(255, 255, 255));
		txtCPAR.setBackground(new Color(54, 54, 54));
		...
		btnGenerate.setBackground(new Color(54, 54, 54));
		...
		txtPE.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				btnGenerate.doClick();
			}
		});
		txtPE.setForeground(new Color(255, 255, 255));
		txtPE.setBackground(new Color(54, 54, 54));
		txtPE.setColumns(10);
		...
		btnMainMenu.setBounds(135, 486, 125, 37);
