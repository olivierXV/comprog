...
public class ThirdStageHalf extends JFrame {
    ...
    private JPanel Explanation() {
        ...
        JLabel welcomeText = new JLabel(
        	    ...
        	    + "<b>3. Formatting Text</b><br><br>"
        	    + "HTML also allows text formatting using different tags:<br><br>"
        	    + "<b>Bold:</b> &lt;b&gt; or &lt;strong&gt; → <strong>Important text</strong><br>"
        	    + "<b>Italic:</b> &lt;i&gt; or &lt;em&gt; → <em>Emphasized text</em><br>"
        	    + "<b>Underline:</b> &lt;u&gt; → <u>Underlined text</u><br>"
        	    + "<b>Line Break:</b> &lt;br&gt; → Adds a line break without starting a new paragraph.<br><br>"
        	    + "</div></html>",
    ...
    private JPanel ExamplePanel() {
        ...
        JLabel txtExample = new JLabel(
        	    ...
        	    + "<p>&lt;p&gt;This is a <strong>&lt;strong&gt;bold&lt;/strong&gt;</strong> or you can use <b>&lt;b&gt;bold&lt;/b&gt;</b>, <em>&lt;em&gt;italic&lt;em&gt;</em>, and <u>&lt;u&gt;underlined&lt;u&gt;</u> text example.&lt;/p&gt;</p>"
        	    + "<p>&lt;p&gt;Line break example: <br> &lt;br&gt;This text appears on a new line.&lt;/p&gt;</p>"
        	    + "</div></html>"
        	);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ThirdStageHalf().setVisible(true));
    }
}